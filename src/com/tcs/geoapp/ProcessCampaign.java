...
/**
 * Servlet implementation class ProcessCampaign
 */
public class ProcessCampaign extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String eDate =  new SimpleDateFormat("yyyy-MM-dd HH:mm").format(date);
			...
			if(count!=0){
				System.out.println("Insertion of Campaign successful!");
			...
			request.removeAttribute("msg");
			 ...
			 st = cnn.prepareStatement("SELECT * FROM geo_mapping WHERE TOKEN_ID=? AND GCM_ID IS NOT NULL");
